    ...
    showBrands: function(){
        ...
        try {
            ...
            if($('mozg_pagseguro_api_boleto_message')){
                ...
                var boleto_type_length = $('mozg_pagseguro_api_boleto_boleto_type').options.length;
        ...
        try {
            ...
            if($('mozg_pagseguro_api_eletronictransfer_message')){
                ...
                var eletronictransfer_type_length = $('mozg_pagseguro_api_eletronictransfer_eletronictransfer_type').options.length;
